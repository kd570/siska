...
<?= $this->section('title') ?>
<title>Tambah Okupasi - SISKA14</title>
<?= $this->endSection() ?>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body col-md-6">
                ...
                <form action="<?= site_url('areaokupasi') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="form-group">
                        <label>Nama Lahan Okupasi</label>
                        <input type="text" name="nama_okupasi" placeholder="Input nama lahan okupasi" value="<?= old('nama_okupasi'); ?>" class="form-control <?= isset($errors['nama_okupasi']) ? 'is-invalid' : null; ?>" id="nama_okupasi"></input>
                        <div class="invalid-feedback"><?= isset($errors['nama_okupasi']) ? $errors['nama_okupasi'] : null; ?></div>
                    </div>
                    <div class="form-group">
                        <label>Nama Pihak Okupan</label>
                        <input type="text" name="nama_okupan" placeholder="Input nama pihak okupan" value="<?= old('nama_okupan'); ?>" class="form-control <?= isset($errors['nama_okupan']) ? 'is-invalid' : null; ?>" id="nama_okupan"></input>
                    ...
                    <div class="form-group">
                        <label>Jenis Sertifikat yang Dimiliki Opkupan</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" placeholder="0,00" step="0.01" name="luas_okupasi" min="0" title="luas_okupasi">
                        </div>
                        <div class="invalid-feedback"><?= isset($errors['luas']) ? $errors['luas'] : null; ?></div>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <textarea name="des_okupasi" placeholder="Input keterangan tambahan" class="form-control <?= isset($errors['des_okupasi']) ? 'is-invalid' : null; ?>"><?= old('des_okupasi'); ?></textarea>
