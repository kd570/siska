...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="#">Bagian</a></div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="<?= site_url('bagian/new'); ?>" class="btn btn-primary">Tambah data</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Deskripsi Bagian</th>
                        ...
                        <tbody>
                            <?php foreach ($bagian as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td style="width: 20%;"><?= $value->nama_uk ?></td>
                                    <td style="width: 40%;"><?= $value->des_bg ?></td>
                                    <td class="text-center" style="width: 20%;">
                                        <a href="<?= site_url('bagian/' . $value->id_bg . '/edit'); ?>" title="Update" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt "></i></a>
                                        <form action="<?= site_url('bagian/' . $value->id_bg); ?>" title="Hapus" method="POST" class="d-inline" id="del-<?= $value->id_bg; ?>">
                                            <?= csrf_field() ?>
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button class="btn btn-danger btn-sm" data-confirm="Hapus data?| Apakah anda yakin menghapus data?" data-confirm-yes="submitDel(<?= $value->id_bg ?>)">
